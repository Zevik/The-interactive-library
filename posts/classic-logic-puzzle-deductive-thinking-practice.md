...
<div class="app-container">
    ...
    <h3>טבלת הגיון (Logic Grid): כלי הבלש שלך!</h3>
    ...
    <div class="logic-grid-container">
        <table class="logic-grid">
            ...
            <tbody>
                ...
                <tr>
                    <td>חלב</td><td class="cell" data-row="drink-Milk" data-col="house-1"></td><td class="cell" data-row="drink-Milk" data-col="house-2"></td><td class="cell" data-row="drink-Milk" data-col="house-3"></td><td class="cell" data-row="drink-Milk" data-col="house-4"></td><td class="cell" data-row="drink-Milk" data-col="house-5"></td>
                </tr>
                <tr>
...
<button id="toggleExplanation">נתקלת בקושי? הצג הסבר על פתרון חידות הגיון</button>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        toggleButton.addEventListener('click', () => {
            ...
            toggleButton.textContent = isHidden ? 'הסתר הסבר' : 'נתקלת בקושי? הצג הסבר על פתרון חידות הגיון';
        });

        // Logic Grid Cell Interaction
        const cells = document.querySelectorAll('.logic-grid .cell');
        ...
        cells.forEach(cell => {
            cell.addEventListener('click', () => {
                ...
                // Update text and add new color class
                ...
                cell.classList.remove('clicked-animation'); // Reset animation
                // Use requestAnimationFrame to ensure class removal happens before re-adding
                requestAnimationFrame(() => {
                     cell.classList.add('clicked-animation');
                     // Remove animation class after it finishes (duration is 0.3s)
                     setTimeout(() => {
                         cell.classList.remove('clicked-animation');
                     }, 300);
                });
