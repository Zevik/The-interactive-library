...
<div id="explanation" class="hidden">
    ...
    <h3>הכירו את חלקי "הגוף" של כלי האבן:</h3>
    ...
    <h4>סיתות לחץ (Pressure Flaking): פיסול בעדינות</h4>
...
<script>
    // IMPORTANT: Replace placeholder image filenames with actual image paths for a real-world application.
    // The images should clearly depict the characteristics described in the explanations.
    const questions = [
        {
            image: "placeholder_hard_hammer.jpg", // Example: Image showing a core/flake with large bulb, thick platform, crude scars.
            options: ["סיתות ישיר קשה", "סיתות ישיר רך", "סיתות לחץ", "טכניקת לוולואה"],
            answer: "סיתות ישיר קשה",
            explanation: "<strong>נכון!</strong> סימני זיהוי מרכזיים לסיתות בפטיש אבן קשה כוללים בולבוס הכאה <strong>גדול ובולט</strong>, מכתש <strong>רחב ועבה</strong>, וצלקות נתזים <strong>גדולות ועמוקות</strong> (על הגרעין או הנתז). טכניקה זו אופיינית לשלבי העיצוב הראשוניים של כלים כבדים."
        },
        {
            image: "placeholder_soft_hammer.jpg", // Example: Image showing a core/flake with smaller bulb, thin platform, elongated scars.
            options: ["סיתות ישיר קשה", "סיתות ישיר רך", "סיתות עקיף", "סיתות לחץ"],
            answer: "סיתות ישיר רך",
            explanation: "<strong>מעולה!</strong> מאפיינים כמו בולבוס הכאה <strong>קטן ועדין</strong>, מכתש <strong>דק יותר</strong>, וצלקות נתזים <strong>מוארכות ושטוחות</strong> מעידים על שימוש בפטיש רך (כמו קרן או עץ). טכניקה זו אפשרה שליטה טובה יותר על צורת הנתזים."
        },
         {
            image: "placeholder_pressure_flaking.jpg", // Example: Image showing a tool edge with very small, regular, shallow scars.
            options: ["סיתות ישיר קשה", "סיתות ישיר רך", "סיתות לחץ", "טכניקת לוולואה"],
            answer: "סיתות לחץ",
            explanation: "<strong>בול!</strong> כשהשפה של הכלי מציגה <strong>צלקות נתזים זעירות, שטוחות ומסודרות בדפוסים קבועים</strong>, זהו סימן מובהק לסיתות לחץ. טכניקה מדויקת זו שימשה לגימור עדין, חידוד השוליים, ויצירת שיניים בכלים כמו ראשי חץ."
        },
         {
            image: "placeholder_levallois_core.jpg", // Example: Image showing a prepared core (like a 'tortoise') with many preparation scars on its surface.
            options: ["סיתות ישיר קשה", "סיתות לחץ", "טכניקת לוולואה", "סיתות עקיף"],
            answer: "טכניקת לוולואה",
            explanation: "<strong>נפלא!</strong> אם אתם רואים גרעין אבן שצורתו <strong>עוצבה בקפידה מראש</strong> (למשל צורת 'צב') ומכוסה <strong>בצלקות הכנה רבות ומסודרות</strong>, זהו גרעין לוולואה. הוא הותאם במיוחד כדי להסיר ממנו נתז או חוד יחיד ומתוכנן."
        },
         {
            image: "placeholder_levallois_flake.jpg", // Example: Image showing a Levallois flake/point with faceted platform and specific dorsal scar pattern.
            options: ["סיתות ישיר רך", "סיתות לחץ", "טכניקת לוולואה", "סיתות עקיף"],
            answer: "טכניקת לוולואה",
            explanation: "<strong>הצלחה!</strong> זיהיתם נתז לוולואה. נתז כזה נוצר מהגרעין המיוחד שהוכן מראש. חפשו צורה <strong>סימטרית ומתוכננת</strong>, <strong>מכתש 'מפוספס'</strong>, ועל צד הגב שלו – <strong>צלקות רבות</strong> המעידות על ההכנה המורכבת של הגרעין לפני הסרתו. אופייני לפליאוליתית התיכונה."
        },
        {
            image: "placeholder_indirect_percussion.jpg", // Example: Image showing a long, regular blade with a very small, discreet platform scar.
            options: ["סיתות ישיר קשה", "סיתות ישיר רך", "סיתות עקיף", "סיתות לחץ"],
            answer: "סיתות עקיף",
            explanation: "<strong>פענוח מדויק!</strong> היכולת ליצור <strong>להבים ארוכים, ישרים ואחידים</strong> היא סימן היכר של סיתות עקיף באמצעות אזמל. שימו לב לנקודת המכה <strong>הקטנה והמוגדרת</strong> על הנתז, ולעיתים היעדר בולבוס הכאה משמעותי. טכניקה זו דורשת מיומנות גבוהה."
        },
        // Add more questions here following the same structure with relevant images and explanations
    ];
