...
<style>
    /* כללי גופן ובסיס */
    body {
        font-family: 'Arial', sans-serif; /* או גופן אחר בעל מראה מודרני */
        line-height: 1.7;
        color: #333;
    ...
    h1, h2, h3 {
        color: #1e3a8a; /* כחול כהה עבור כותרות */
        margin-bottom: 15px;
    }

    h1 {
        text-align: center;
        color: #0056b3; /* כחול הדגל */
        margin-bottom: 30px;
        text-shadow: 1px 1px 2px rgba(0,0,0,0.1);
    }

    /* אפליקציה אינטראקטיבית - מסגרת ותחושה */
    #interactive-app {
        margin: 30px auto; /* מרווח עליון ותחתון, ממורכז */
        padding: 30px;
        border: 1px solid #d1d1d1;
        border-radius: 12px; /* פינות מעוגלות יותר */
        background: linear-gradient(to bottom, #ffffff, #f0f0f0); /* רקע עם גרדיאנט עדין */
        text-align: center;
        box-shadow: 0 8px 16px rgba(0,0,0,0.1); /* צל בולט יותר */
        transition: background-color 0.8s ease; /* אנימציית שינוי רקע */
        position: relative; /* עבור שכבת כיסוי UV */
        overflow: hidden; /* לוודא ששכבות לא חורגות */
    }
    ...
    #interactive-app::before {
        ...
        right: 0;
        bottom: 0;
        background-color: rgba(70, 0, 150, 0.2); /* גוון סגול כהה עדין */
        pointer-events: none; /* מאפשר קליקים על האלמנטים שמתחת */
        opacity: 0; /* מוסתר בהתחלה */
        transition: opacity 0.8s ease; /* אנימציית הופעה */
        z-index: 1; /* מעל התוכן, מתחת לכפתור */
    }

    /* מצב UV פעיל */
    #interactive-app.uv-active {
         background: #1a1a2e; /* רקע כהה במצב UV */
         border-color: #4a0e78; /* גבול בצבע UV */
         box-shadow: 0 8px 20px rgba(74, 14, 120, 0.5); /* צל זוהר במצב UV */
    }

    #interactive-app.uv-active::before {
