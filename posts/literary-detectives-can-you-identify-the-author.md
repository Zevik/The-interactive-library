...
<div id="explanation-content" style="display: none;">
    ...
    <ul>
        ...
        <li>**נושאים וגישה רגשית/פילוסופית: ** לא רק מה הנושא, אלא איך הסופר ניגש אליו. האם מתוך חמלה, ניתוח אינטלקטואלי, סרקזם, פליאה? הגישה הרגשית והפילוסופית משפיעה על הטון ועל ההבנה העמוקה של היצירה.</li>
    </ul>
...
<script>
    const questions = [
        {
            snippet: "הוא ידע שהאדמה הזאת תעלה על הדעת הכל, והוא גם ידע שהיא תעלה על הדעת רק את מה שהיא רוצה, ובזמן שהיא רוצה, ובדרך שהיא רוצה, ואין לה שום כוונה להתחשב בו.",
            options: ["מאיר שלו", "עמוס עוז", "אתגר קרת", "א.ב. יהושע"],
            correctAnswer: "מאיר שלו",
            explanation: "ההתייחסות הפואטית לאדמה כאל ישות בעלת רצון עצמאי, והחזרתיות המקצבית כמעט טקסית של מבנה המשפט ('שהיא רוצה') יוצרות אווירה ייחודית. סגנון זה, המרבה לעסוק בחיבור עמוק ומיסטי בין אדם למקום ובכוחות טבע ראשוניים, אופייני ביותר למאיר שלו."
        },
        {
            snippet: "ואז היא הסתכלה לי בעיניים ואמרה, 'אתה יודע, זה קצת כמו לקפוץ מהגג.' ואני הסכמתי.",
            options: ["אתגר קרת", "צרויה שלו", "דויד גרוסמן", "לאה גולדברג"],
            correctAnswer: "אתגר קרת",
            explanation: "מאפיינים כמו קוצר המשפטים, הדיאלוגים הישירים והמינימליסטיים, והמצבים האבסורדיים או המטאפוריים לחלוטין, מהווים 'טביעות אצבע' מובהקות של סגנונו הסיפורי של אתגר קרת, המצליח ללכוד מורכבות אנושית בפשטות מפתיעה."
        },
        {
            snippet: "הרחוב היה שקט מאוד, שקט שאינו ריק אלא מלא באוויר דומם וצפוי, מין שקט של אחרי אסון שטרם התרחש.",
            options: ["עמוס עוז", "מאיר שלו", "נסים אלוני", "יעקב שבתאי"],
            correctAnswer: "עמוס עוז",
            explanation: "היכולת לתאר אווירה פסיכולוגית דחוסה ('שקט שאינו ריק אלא מלא'), והכנסת ממד של מתח וצפייה לאסון שעדיין לא קרה, אופייניים לסגנונו הפיוטי, המעמיק והרגיש של עמוס עוז, המצטיין בתיאורי נוף נפשי ופיזי כאחד."
        },
        {
            snippet: "היא הרגישה שהבית מתכווץ סביבה, הקירות נושמים פנימה והחוצה במין קצב איטי ומאיים, כאילו הדירה כולה הפכה ליצור חי שמנסה לבלוע אותה.",
            options: ["צרויה שלו", "אתגר קרת", "עמוס עוז", "א.ב. יהושע"],
            correctAnswer: "צרויה שלו",
            explanation: "התיאור האינטנסיבי, החושני והמטאפורי של תחושות פנימיות (חרדה, מצוקה) ככוחות פיזיים כמעט ('הבית נושם', 'מנסה לבלוע'), וההתמקדות העמוקה בעולם הרגשי הסוער של הדמויות, מאפיינים מאוד את סגנונה הפסיכולוגי המותח של צרויה שלו."
        },
         {
            snippet: "העיר יפה כמו זכוכית, אבל זכוכית ששקע בה כבר לכלוך ראשון, שייף קל של הזנחה מתחילה. היה משהו שברירי ומלוכלך כאחד, ששבה את לבו מייד.",
            options: ["דויד גרוסמן", "מאיר שלו", "אתגר קרת", "יעקב שבתאי"],
            correctAnswer: "דויד גרוסמן",
            explanation: "הדימויים המורכבים והרב-שכבתיים המשלבים יופי ושבריריות, קסם ודעיכה ('יפה כמו זכוכית... שייף קל של הזנחה'), והיכולת ללכוד רגע של תחושה מורכבת וניואנסית, הם סימני הכר לסגנונו העשיר, הפיוטי והרגיש של דויד גרוסמן, המתבונן בעולם בעין חדה ובלב פתוח."
        }
    ];
    ...
    const quizContainer = document.getElementById('quiz-container'); // Added reference to container
    ...
    function checkAnswer(selectedButton, selectedAnswer) {
        ...
        explanationElement.textContent = 'הסבר: ' + currentQuestion.explanation;
