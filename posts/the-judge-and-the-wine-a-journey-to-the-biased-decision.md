...
<div id="explanation" class="explanation-section">
    ...
    <h3>הטיית אישור (Confirmation Bias): למה אנחנו אוהבים לשמוע שצדקנו?</h3>
...
<script>
    const wines = [
        {
            ...
            hint: {
                type: "score",
                value: "שופט מומחה בעל שם העניק ציון 93 ליין זה.",
                bias: "אפקט העוגן (השפעת ציון חיצוני)"
            },
            initialScore: null,
            finalScore: null
        },
        {
            ...
            hint: {
                type: "price",
                value: "המחיר המומלץ לצרכן של היין הוא 70 ש\"ח.", // Example of a lower value hint
                bias: "אפקט העוגן (השפעת מחיר)"
            },
            initialScore: null,
            finalScore: null
        },
         {
            ...
            hint: {
                type: "description",
                value: "תיאור רשמי: יין לבן מורכב ואלגנטי, עם רמזים לפרי טרופי בשל, מינרליות עדינה וסיומת ארוכה ומרעננת.", // Positive description
                bias: "הטיית אישור / אפקט המסגור (השפעת תיאור מילולי)"
            },
            initialScore: null,
            finalScore: null
        },
        {
            ...
            hint: {
                type: "origin",
                value: "ארץ מוצא: עמק הרון המפורסם, צרפת.", // Prestigious origin
                bias: "הטיית אישור / הטיית האלו (השפעת מוניטין / מקור)"
            },
            initialScore: null,
            finalScore: null
        }
    ...
    function submitFinalScore(wineId) {
        ...
        if (absoluteDifference > 0) {
             ...
             if (absoluteDifference >= 5) { // Threshold for 'significant' change
