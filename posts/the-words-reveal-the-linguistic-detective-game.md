...
<div class="app-container">
    ...
    <div class="selection-and-feedback">
...
<div id="explanation" class="hidden" dir="rtl">
    ...
    <h3>חשוב לזכור: זה לא קסם</h3>
    <p>בלשנות משפטית היא כלי רב עוצמה, אך לא מושלם. 'טביעת אצבע לשונית' יכולה להשתנות, אנשים יכולים לנסות לזייף סגנון, ולפעמים אין מספיק טקסט להשוואה. לכן, ממצאים לשוניים משמשים לרוב כראיה תומכת, חלק מפסיפס רחב יותר של ראיות.</p>

    <h3>סיפור מהשטח: ה"אאונובומר" והמניפסט</h3>
    <p>אחד המקרים המפורסמים ביותר שבהם בלשנות משפטית הייתה קריטית הוא פרשת טד קזינסקי, ה"אאונובומר". אחרי שנים של שליחת מטעני חבלה, הוא פרסם מניפסט. אחיו, שקרא אותו, זיהה מיד את סגנון הכתיבה הייחודי של טד. בלשנים משפטיים אישרו את הזיהוי על ידי השוואת המניפסט למכתבים קודמים שטד כתב. ניתוח זה היה ראיה מרכזית שהובילה למעצרו והרשעתו.</p>
</div>
...
<style>
    :root {
        ...
        --border-color: #bdc3c7; /* Grey */
        --text-color: #34495e; /* Dark Grey/Blue */
        --selected-border: var(--primary-color);
        --feedback-correct: var(--secondary-color);
        --feedback-incorrect: #e74c3c; /* Red */
        --highlight-color: #ffff99; /* Light Yellow for highlighting */
        ...
        suspectCards.forEach(card => {
            card.addEventListener('click', () => {
                ...
                setTimeout(() => {
                 ...
                 // Remove any existing highlights when a new card is selected
                 removeAllHighlights();
            });
        });
